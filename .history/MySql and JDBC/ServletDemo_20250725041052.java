...
import java.sql.Statement; // Corrected: This was missing previously
import java.sql.SQLException; // Corrected: This was missing previously
import jakarta.servlet.ServletException;
import jakarta.servlet.http.HttpServlet;
import jakarta.servlet.http.HttpServletRequest; // <--- CORRECTED IMPORT
import jakarta.servlet.http.HttpServletResponse; // <--- CORRECTED IMPORT
...
public class ServletDemo extends HttpServlet {
      public void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            try {
                  ...
                  // However, "com.mysql.jdbc.Driver" might still work due to backward
                  // compatibility.
                  ...
                  throw new ServletException(
                              "JDBC Driver not found. Make sure mysql-connector-j-x.x.x.jar is in WEB-INF/lib.", e);
            } finally {
